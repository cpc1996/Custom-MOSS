...
u0=[75*pi/180,0]; g=9.81; L=1,2;m=1; k=0;
w=sqrt(g/L); T=2*pi/w;
t1=0:0.1:2*T;
sm0=subs(st0); st1=['[u(2);',char(sm0),']'];
du1=inline(st1,'t','u');
[t,u]=ode45(du1,t1,u0);
s=u(:,1);dth1=u(:,2);
...
u0=[75*pi/180,0]; g=9.81; L=1,2;m=1; gama=0.01;
k=0.01;w=sqrt(g/L); T=2*pi/w;
t1=0:0.1:5*T;
sm0=subs(st0); st1=['[u(2);',char(sm0),']'];
du1=inline(st1,'t','u');
[t,u]=ode45(du1,t1,u0);
...
plot(t1,s,'r');
figure(4)
plot(t1,Ep1,'r'); hold on;
plot(t1,Ek1,'b');
plot(t1,Et1,'k'); hold off
